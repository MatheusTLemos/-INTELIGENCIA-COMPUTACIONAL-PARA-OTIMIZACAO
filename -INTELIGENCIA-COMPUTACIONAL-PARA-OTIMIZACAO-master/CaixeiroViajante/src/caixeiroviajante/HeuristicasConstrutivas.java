...
public class HeuristicasConstrutivas {
    ...
    public void VizinhoMaisProximo() {
        ...
        System.out.println("Solucao nao  refinada");
        ...
        while (userChoice != 1 && userChoice != 2 && userChoice != 3 && userChoice != 4&& userChoice!=5) {
            ...
            System.out.println("4-Metodo VND");
            System.out.println("5-metodo TABU");
            ...
            switch (userChoice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Solucao = refinamento.metodoVND(Solucao);
                    break;
                case 5:
                    System.out.println("Numero de iteracoes");
                    iteracoes = Entrada.nextInt();
                    Solucao = refinamento.metodoTabu(Solucao, iteracoes);
                    break;
